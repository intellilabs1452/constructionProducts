...
use App\InhousesalesExport;
use App\SellersalesExport;
use App\WishlistExport;
use App\UsersearchExport;
use App\CommissionExport;
class ReportController extends Controller
{
    ...
    public function export(Request $request)
    {
       if ($request->has('id')){
        ...
        {
        return Excel::download(new InhousesalesExport($request), 'inhouse_sales_report.xlsx');
        }
       elseif($request->type=='seller')
        {
        return Excel::download(new SellersalesExport($request), 'seller_sales_report.xlsx');
        }
        elseif($request->type=='wish')
        {
        return Excel::download(new WishlistExport($request), 'wishlist_report.xlsx');
        }
         elseif($request->type=='usersearch')
        {
        return Excel::download(new UsersearchExport(), 'usersearch_report.xlsx');
        }
