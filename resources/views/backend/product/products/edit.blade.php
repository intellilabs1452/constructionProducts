    ...
    <form class="form form-horizontal mar-top" action="{{route('products.update', $product->id)}}" method="POST" enctype="multipart/form-data" id="choice_form">
        <div class="row gutters-5">
            <div class="col-lg-8">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group row">
                                 <label class="col-md-3 col-from-label">
                                     {{ translate('Skilled Trades') }} <span class="text-primary">*</span></label>
                            <div class="col-md-8">
                ...
                <div class="card">
                    <div class="card-header">
                        <h5 class="mb-0 h6">{{translate('Linked Products')}}</h5>
                    </div>
                    <div class="card-body">
                        <div class="form-group row gutters-5">
                            <div class="col-lg-3">
                            ...
                            <div class="col-lg-8">
                               <select class="form-control aiz-selectpicker" data-live-search="true" data-selected-text-format="count" name="linked[]" id="linked" multiple>
                                    @foreach (\App\Product::orderBy('name', 'asc')->get() as $key => $products)
                                    <option
                                        value="{{ $products->id }}"
                                        data-content="<span><span>{{ $products->name }}</span></span>"
                                        <?php if (in_array($products->id, json_decode($product->linked_products))) echo 'selected' ?>
                                        ></option>
                                    @endforeach
                                </select>
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="form-group row gutters-5">
                            <div class="col-lg-3">
                                <input type="text" class="form-control" value="{{translate('Locations')}}" >
                            </div>
                            <div class="col-lg-8">
