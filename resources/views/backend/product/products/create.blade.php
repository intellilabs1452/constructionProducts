            ...
            <div class="col-lg-8">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group row" hidden>
                            ...
                            <div class="col-md-8">
                            <select class="form-control aiz-selectpicker" data-live-search="true" data-selected-text-format="count" name="segment[]" id="segment" multiple>
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="form-group row gutters-5">
                            <div class="col-md-3">
                                <input type="text" class="form-control" value="{{translate('Products')}}" disabled>
                            </div>
                            <div class="col-md-8">
                                <select class="form-control aiz-selectpicker" data-live-search="true" data-selected-text-format="count" name="linked[]" id="linked" multiple>
                                    ...
                                    <option  value="{{ $products->id }}" data-content="<span><span>{{ $products->name }}</span></span>"></option>
                                    @endforeach
                                </select>
                            </div>
