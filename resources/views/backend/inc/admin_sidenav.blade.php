                    ...
                    <li class="aiz-side-nav-item">
                        ...
                        <ul class="aiz-side-nav-list level-2">
                            ...
                            <li class="aiz-side-nav-item">
                             ...
                             <li class="aiz-side-nav-item">
                                <a href="{{route('segments.index')}}" class="aiz-side-nav-link {{ areActiveRoutes(['segments.index', 'segments.create', 'segments.edit'])}}" >
                                    <span class="aiz-side-nav-text">{{translate('Segment')}}</span>
                                </a>
                            </li>
                             <li class="aiz-side-nav-item">
                                <a href="{{route('speciality.index')}}" class="aiz-side-nav-link {{ areActiveRoutes(['speciality.index', 'speciality.create', 'speciality.edit'])}}" >
                                    <span class="aiz-side-nav-text">{{translate('Speciality')}}</span>
                                </a>
                            </li>
                            <li class="aiz-side-nav-item">
                                <a href="{{route('skilledtrades.index')}}" class="aiz-side-nav-link {{ areActiveRoutes(['skilledtrades.index', 'skilledtrades.create', 'skilledtrades.edit'])}}" >
                                    <span class="aiz-side-nav-text">{{translate('Skilled Trades')}}</span>
                                </a>
                            </li>
                            <li class="aiz-side-nav-item">
                    ...
                    <ul class="aiz-side-nav-list level-2">
                        ...
                        @if(Auth::user()->user_type == 'admin' || in_array('6', json_decode(Auth::user()->staff->role->permissions)))
                            <li class="aiz-side-nav-item">
                             ...
                             <li class="aiz-side-nav-item">
                                <a href="{{ route('credit_report') }}" class="aiz-side-nav-link {{ areActiveRoutes(['pick_up_point.order_index','pick_up_point.order_show'])}}">
                        ...
                        <ul class="aiz-side-nav-list level-2">
                            ...
                            @if (1)
                                <li class="aiz-side-nav-item">
                                 ...
                                 <li class="aiz-side-nav-item">
                                    <a href="{{ route('location.index') }}" class="aiz-side-nav-link {{ areActiveRoutes(['location.index', 'seller_packages.create', 'seller_packages.edit'])}}">
                                        <span class="aiz-side-nav-text">{{ translate('Seller Locations') }}</span>
                                        @if (env("DEMO_MODE") == "On")
                                            <span class="badge badge-inline badge-danger">Addon</span>
                                        @endif
                                    </a>
