...
<div class="row">
    <div class="col-md-8 mx-auto">
        <div class="card">
            ...
            @if ($sort_by=='')          
        <a class="btn btn-warning" href="{{ route('export') }}?type={{'wish'}}" id="export">Export</a>
           @else
    <a class="btn btn-warning" href="{{ route('export') }}?id={{$sort_by}}&type={{'wish'}}" id="export">Export</a>
@endif
                        </div>
                    </div>
                </form>
