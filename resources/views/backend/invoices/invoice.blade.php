	...
	<div>
		...
		<div style="padding: 1rem;padding-bottom: 0">
            <table>
				...
				@else
				<tr><td class="strong small gry-color">&nbsp;</td></tr>
				<tr><td class="strong">{{ $shipping_address->name }}</td></tr>
			...
			<div style="padding: 1rem;padding-bottom: 0;margin-top:-110px">
            <table>
			    <tr><td class="text-right strong small gry-color">{{ translate('Ship From') }}:</td></tr>
				<tr><td class="text-right strong">{{ $seller->name }}</td></tr>
				<tr><td class="text-right gry-color small">{{ $seller->address }}</td></tr>
				<tr><td class="text-right gry-color small">{{ $seller->phone }}</td></tr>
							...
							<tr class="">
								...
								<td>
									...
									@elseif ($orderDetail->shipping_type == 'pickup_point')
										...
										@endif
									@elseif ($orderDetail->shipping_type == 'pickup_store')
										{{ translate('Pickup from Store') }}
									@endif
								</td>
