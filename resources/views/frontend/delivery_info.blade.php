                ...
                <div class="row aiz-steps arrow-divider">
                    ...
                    <div class="col done">
                        <div class="text-center text-primary ">
                            ...
                            <h3 class="fs-14 fw-600 d-none d-lg-block">{{ translate('3. Shipping info')}}</h3>
                        </div>
                    </div>
            ...
            <div class="col-xxl-8 col-xl-10 mx-auto">
                <form class="form-default" action="{{ route('checkout.store_delivery_info') }}" role="form" method="POST">
                                ...
                                <div class="col-md-6">
                                    <div class="row gutters-5">
                                        <div class="col-6">
                                         ...
                                         <div class="col-6">
                                            <label class="aiz-megabox d-block bg-white mb-0">
                                                <input type="radio" name="shipping_type_{{ \App\User::where('user_type', 'admin')->first()->id }}" value="pickupstore" data-target=".pickup_point_id_admin">
                                                <span class="d-flex p-3 aiz-megabox-elem">
                                                    <span class="aiz-rounded-check flex-shrink-0 mt-1"></span>
                                                    <span class="flex-grow-1 pl-3 fw-600">{{  translate('Pickup from Store') }}</span>
                                                </span>
                                            </label>
                                        </div>
                                        ...
                                        <div class="col-md-6">
                                            <div class="row gutters-5">
                                                <div class="col-6">
                                                 ...
                                                 <div class="col-6">
                                            <label class="aiz-megabox d-block bg-white mb-0">
                                                <input type="radio" name="shipping_type_{{ $key }}" value="pickupstore" data-target=".pickup_point_id_admin">
                                                <span class="d-flex p-3 aiz-megabox-elem">
                                                    <span class="aiz-rounded-check flex-shrink-0 mt-1"></span>
                                                    <span class="flex-grow-1 pl-3 fw-600">{{  translate('Pickup from Store') }}</span>
                                                </span>
                    ...
                    <div class="pt-4 d-flex justify-content-between align-items-center">
                        ...
                        <button type="submit" class="btn fw-600 btn-primary">{{ translate('Continue to Shipping Info')}}</button>
                    </div>
                </form>
            </div>
        </div>
