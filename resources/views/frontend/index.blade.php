...
@section('content')
                                ...
                                <li class="minw-0 col-4 col-md mt-3">
                                    <a href="{{ route('products.category', $category->slug) }}" class="d-block rounded bg-white p-2 text-reset shadow-sm">
                                        <img
                                            ...
                                            alt="{{ $category->getTranslation('name') }}" title="{{ $category->getTranslation('name') }}"
 ...
 <div id="section_premium_sellers">
    ...
    <script>
        $(document).ready(function(){
            ...
            $.post('{{ route('home.section.best_sellers') }}', {_token:'{{ csrf_token() }}'}, function(data){
             ...
             $.post('{{ route('home.section.premium_sellers') }}', {_token:'{{ csrf_token() }}'}, function(data){
                $('#section_premium_sellers').html(data);
                AIZ.plugins.slickCarousel();
            });
            @endif
        });
