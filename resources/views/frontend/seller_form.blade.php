    ...
    <div class="container text-center">
        <div class="row">
            <div class="col-lg-6 text-center text-lg-left">
                <h1 class="fw-600 h4">{{ translate('Register your Business')}}</h1>
            </div>
            <div class="col-lg-6">
             ...
             <div class="col-xxl-5 col-xl-6 col-md-8 mx-auto">
                <form id="shop" class="" action="{{ route('shops.store') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="bg-white rounded shadow-sm mb-4">
                        ...
                        <div class="p-3">
                            <div class="form-group">
                                <label>{{ translate('Business Name')}} <span class="text-primary">*</span></label>
                                <input type="text" class="form-control" placeholder="{{ translate('Business Name')}}" name="name" required>
                            </div>
                            <!-- <div class="form-group">
                            ...
                            <div class="form-group">
                                <label>
                                     {{ translate('Address') }} <span class="text-primary">*</span></label>
                    ...
                    <div class="text-right">
                        <button type="submit" class="btn btn-primary fw-600">{{ translate('Register Your Business')}}</button>
                    </div>
                </form>
            </div>
        </div>
