                    ...
                    <div class="col-xl-3">
                        <div class="aiz-filter-sidebar collapse-sidebar-wrap sidebar-xl sidebar-right z-1035">
                            ...
                            <div class="collapse-sidebar c-scrollbar-light text-left">
                                ...
                                <div class="bg-white shadow-sm rounded mb-3">
                                        <div class="fs-15 fw-600 p-3 border-bottom locationheader dropdown-toggle" data-toggle="collapse" data-target="#locationbody">
                                            {{ translate('Locations') }} 
                                        </div>
                                        <div class="p-3 locationbody" id="locationbody">
                                            <div class="aiz-checkbox-list">
                                            @php
                                            $locations=\App\Models\SellerLocation::orderBy('id', 'desc')->get();
                                            @endphp
                                                @foreach ($locations as $location)
                                                    <label class="aiz-checkbox">
                                                        <input
                                                            type="checkbox"
                                                            name="locationfilter[]"
                                                            value="{{ $location->id }}" @if (in_array($location->id, $locationfilter)) checked @endif
                                                            onchange="filter()"
                                                        >
                                 ...
                                 <div class="bg-white shadow-sm rounded mb-3">
                                        <div class="fs-15 fw-600 p-3 border-bottom dropdown-toggle" data-toggle="collapse" data-target="#brandbody" >
                                            {{ translate('Brands') }} 
                                        </div>
                                        <div class="p-3" id="brandbody" class="collapse">
                                            <div class="aiz-checkbox-list">
                                            @php
                                                ...
                                                @foreach ($brands as $brand)
                                                    <label class="aiz-checkbox">
                                                        <input
                                                            type="checkbox"
                                                            name="brandfilter[]"
                                                            value="{{ $brand->id }}" @if (in_array($brand->id, $brandfilter)) checked @endif
                                                            onchange="filter()"
                                                        >
                                                        <span class="aiz-square-check"></span>
                                ...
                                <div class="bg-white shadow-sm rounded mb-3" hidden>
                                    <div class="fs-15 fw-600 p-3 border-bottom">
                    ...
                    <div class="col-xl-9">
                        ...
                        <ul class="breadcrumb bg-transparent p-0">
                            ...
                            <li class="breadcrumb-item opacity-50">
                                <a class="text-reset" href="{{ route('product', $pid) }}">{{ translate($pid)}}</a>
                            </li>
                             @else
                                <li class="breadcrumb-item opacity-50">
                            ...
                            @endif
                            @if(!isset($category_id)&&empty($linked))
                                <li class="breadcrumb-item fw-600  text-dark">
                                    <a class="text-reset" href="{{ route('search') }}">"{{ translate('All Categories')}}"</a>
                                </li>
                             @elseif(!empty($linked))
                                <li class="breadcrumb-item opacity-50">
                                    <a class="text-reset" href="">{{ translate('Linked Products')}}</a>
                                </li>
                        ...
                        <div class="text-left">
                            <div class="d-flex align-items-center">
                                ...
                                <div class="form-group ml-auto mr-0 w-200px d-none d-xl-block" hidden>
                                    <label class="mb-0 opacity-50">{{ translate('Brands')}}</label>
                                    <select class="form-control form-control-sm aiz-selectpicker" data-live-search="true" name="brand" onchange="filter()" hidden>
                                ...
                                <div class="form-group w-200px ml-0 ml-xl-3" hidden>
