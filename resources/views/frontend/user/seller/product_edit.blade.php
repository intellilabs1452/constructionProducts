                    ...
                    <div class="form-group row" id="brand">
                     ...
                     <div class="form-group row">
                                 <label class="col-md-3 col-from-label">
                                     {{ translate('Locations') }} <span class="text-primary">*</span></label>
                            <div class="col-md-8 new">
                            <select class="form-control aiz-selectpicker location" data-live-search="true" data-selected-text-format="count" name="location[]" id="location" data-max-options="{{ $segments->segments}}" multiple>
                                    @foreach (\App\Models\SellerLocation::orderBy('name', 'asc')->get() as $key => $location)
                                    <option
                                        value="{{ $location->id }}"
                                        data-content="<span><span>{{ $location->name }}</span></span>"
                                        <?php if (in_array($location->id, json_decode($product->locations))) echo 'selected' ?>
                                        ></option>
                                    @endforeach
                                </select>
                            </div>
                        ...
                        <div class="form-group row" hidden>
                            ...
                            <div class="col-md-8 new">
                            <select class="form-control aiz-selectpicker segment_id" data-live-search="true" data-selected-text-format="count" name="segment[]" id="segment" data-max-options="{{ $segments->segments}}" multiple>
                            ...
                            <div class="col-md-8">
                            <select class="form-control aiz-selectpicker" data-live-search="true" data-selected-text-format="count" name="speciality[]" id="speciality" multiple>
                            ...
                            <select class="form-control aiz-selectpicker" data-live-search="true" data-selected-text-format="count" name="skilledtrade[]" id="skilledtrade" multiple>
                                    ...
                                    <option value="{{ $skilledtrade->id }}"
                                        data-content="<span><span>{{ $skilledtrade->name }}</span></span>"   <?php if (in_array($skilledtrade->id, json_decode($product->skilledtrades))) echo 'selected' ?>></option>
                                    @endforeach
                                </select>
                            </div>
                            </div>
            ...
            <div class="form-group row">
                ...
                <div class="col-md-8">
                    ...
                    <div class="file-preview box sm">
                        ...
                        <div class="col-md-8">
                            <textarea class="aiz-text-editor" name="pdf_description">{{$product->pdf_description}}</textarea>
                        </div> 
                        </div>
        </div>
    </div>
        ...
        $.ajax({
            ...
            success: function(data) {
                ...
                <div class="form-group row">\
                    ...
                    <div class="col-md-8">\
                        <input type="text" class="form-control aiz-tag-input" name="choice_options_'+i+'[]" placeholder="{{ translate('Enter choice values') }}" data-on-change="update_sku"></div></div>');
