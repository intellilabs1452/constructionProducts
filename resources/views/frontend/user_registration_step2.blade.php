...
@section('content')
            ...
            <div class="container">
                <div class="row">
                    <div class="col-xxl-4 col-xl-8 col-lg-8 col-md-12 mx-auto">
                        <div class="card">
                            <div class="">
                            <p style="color:red;text-align:left;padding:5px">
                              	Kindly fill in the following fields in order to continue with the registration process. Or you can skip this now and do later if needed.  
                            </p>
                                <a class="btn btn-block fw-600" href="{{ route('dashboard') }}" style="background-color:green;color:white;text-decoration:underline">Do Later</a>
                            </div>
                             <div class="text-center pt-4">
                                <h1 class="h4 fw-600">
                                    {{ translate('Customer Registration/ Credit Facility Form.')}}
                                </h1>
                              
                            </div>
                            <div class="px-3 py-3 py-lg-4">
                                <div class="">
                                 <form id="reg2-form" class="form-default" role="form" action="{{ route('user.register2') }}" method="POST" enctype="multipart/form-data">
                                        @csrf
                                         <input type="hidden" name="user_id"  value="{{ $id }}">
                                        <div class="form-group">
                                            <input type="text" class="form-control{{ $errors->has('company_name') ? ' is-invalid' : '' }}" value="{{ old('company_name') }}" placeholder="{{  translate('Company Name') }}" name="company_name">
                                            ...
                                            @endif
                                                                                ...
                                                                                <div class="form-group">
                                            <input type="text" class="form-control{{ $errors->has('street_address') ? ' is-invalid' : '' }}" value="{{ old('street_address') }}" placeholder="{{  translate('Street address') }}" name="street_address">
                                        ...
                                        <div class="row">
                                            ...
                                            <input type="text" class="form-control{{ $errors->has('postbox') ? ' is-invalid' : '' }}" value="{{ old('postbox') }}" placeholder="{{  translate('Post Box') }}" name="postbox">
  ...
  <div class="row">
                    ...
                    @endforeach
                                        ...
                                        <div class="form-group col-md-6">
                                            <input type="text" class="form-control{{ $errors->has('office_email') ? ' is-invalid' : '' }}" value="{{ old('office_email') }}" placeholder="{{  translate('Office Email') }}" name="office_email">
 ...
 <div class="row">
                                                                                <div class="form-group col-md-6">
                                            <input type="text" class="form-control{{ $errors->has('office_telephone') ? ' is-invalid' : '' }}" value="{{ old('office_telephone') }}" placeholder="{{  translate('Office Telephone') }}" name="office_telephone">
                                        ...
                                        <div class="form-group col-md-6">
                                            <input type="text" class="form-control{{ $errors->has('office_fax') ? ' is-invalid' : '' }}" value="{{ old('Office Fax') }}" placeholder="{{  translate('Office Fax') }}" name="office_fax">
 ...
 <div class="form-group col-md-6">
                            <div class="input-group" data-toggle="aizuploader" data-type="document">
                                ...
                                <input type="hidden" name="trade_license" class="selected-files" value="">
                            </div>
                            ...
                            <div class="form-group col-md-6">
                                            ...
                                            <input type="text" placeholder="Validity" name="trade_license_validity" class="form-control{{ $errors->has('trade_license_validity') ? ' is-invalid' : '' }}">
 ...
 <div class="form-group col-md-6">
                            <div class="input-group" data-toggle="aizuploader" data-type="document">
                                ...
                                <input type="hidden" name="chamber_of_commerce" class="selected-files" value="">
                            </div>
                            <div class="file-preview box sm">
                            </div>
                            </div>
                            <div class="form-group col-md-6">
                                             ...
                                             <input type="text" placeholder="Validity" name="coc_validity" class="form-control{{ $errors->has('coc_validity') ? ' is-invalid' : '' }}" >
 ...
 <div class="form-group col-md-6">
                            <div class="input-group" data-toggle="aizuploader" data-type="document">
                                ...
                                <input type="hidden" name="vat_certificate_no" class="selected-files" value="">
                            </div>
                            <div class="file-preview box sm">
                            </div>
                            </div>
                    ...
                    @endforeach
                            ...
                            <div class="row">
                                                                                <div class="form-group col-md-6">
                                            <input type="text" class="form-control{{ $errors->has('sister_companies') ? ' is-invalid' : '' }}" value="{{ old('sister_companies') }}" placeholder="{{  translate('Sister Companies/ Group Name') }}" name="sister_companies">
                    ...
                    @endforeach
                            ...
                            <div class="row">
                                                                                <div class="form-group col-md-6">
                                            <input type="text" class="form-control{{ $errors->has('trade_ref') ? ' is-invalid' : '' }}" value="{{ old('trade_ref') }}" placeholder="{{  translate('Trade References/Person Name') }}" name="trade_ref">
                                        ...
                                        <div class="form-group col-md-6">
                                            <input type="text" class="form-control{{ $errors->has('trade_ref_tel') ? ' is-invalid' : '' }}" value="{{ old('trade_ref_tel') }}" placeholder="{{  translate('Telephone no') }}" name="trade_ref_tel">
                             ...
                             <div class="row">
                                        ...
                                        <div class="form-group col-md-6">
                                             <select name="credit_period" class="form-control{{ $errors->has('credit_period') ? ' is-invalid' : '' }}">
                                                ...
                                                <option value="60">{{  translate('60 Days') }}</option>
                                                <option value="90">{{  translate('90 Days') }}</option>
                                                  <option value="120">{{  translate('120 Days') }}</option>
                             ...
                             <div class="row">
                                            ...
                                            <input type="text" class="form-control{{ $errors->has('initial_credit_limit') ? ' is-invalid' : '' }}" value="{{ old('initial_credit_limit') }}" placeholder="{{  translate('Initial Credit Limit(AED)') }}" name="initial_credit_limit">
 ...
 <div class="col-md-6">
                            <div class="input-group" data-toggle="aizuploader" data-type="document">
                                ...
                                <input type="hidden" name="authorized_person" class="selected-files" value="">
                            </div>
                            <div class="file-preview box sm">
                            </div>
                            </div>
 ...
 <div class="row">
                                                                                <div class="form-group col-md-6">
                                            <input type="text" class="form-control{{ $errors->has('authorized_office_email') ? ' is-invalid' : '' }}" value="{{ old('authorized_office_email') }}" placeholder="{{  translate('Office Email') }}" name="authorized_office_email">
                                        ...
                                        <div class="form-group col-md-6">
                                            <input type="text" class="form-control{{ $errors->has('authorized_tel_no') ? ' is-invalid' : '' }}" value="{{ old('authorized_tel_no') }}" placeholder="{{  translate('Tel no') }}" name="authorized_tel_no">
 ...
 <div class="row">
       ...
       <div class="row">
            <div class="form-group col-md-12">
             ...
             <div class="form-group col-md-12">
                <input type="text" name="user_designation" placeholder="Designation" class="form-control">
            </div>
             <div class="form-group col-md-6">
                <input type="date" name="registration_date" placeholder="Date" class="form-control" value="{{ date('Y-m-d') }}">
            </div>
             <div class="form-group col-md-6">
  ...
  <div style="float:right">
       <button type="submit" class="btn btn-primary btn-block fw-600">{{  translate('Complete Registration') }}</button>
  </div>
