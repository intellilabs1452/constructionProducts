            ...
            <div class="col-lg-8">
                <form action="{{ route('payment.checkout') }}" class="form-default" role="form" method="POST" id="checkout-form">
                                        ...
                                        @if(get_setting('cash_payment') == 1)
                                            ...
                                            @if($digital != 1 && $cod_on == 1)
                                                <div class="col-6 col-md-4">
                                                 ...
                                                 <div class="col-6 col-md-4">
                                                    <label class="aiz-megabox d-block mb-3">
                                                        <input value="onlinepayment" class="online_payment" type="radio" name="payment_option">
                                                        <span class="d-block p-3 aiz-megabox-elem">
                                                            <img src="{{ static_asset('assets/img/cards/cod.png')}}" class="img-fluid mb-2">
                                                            <span class="d-block text-center">
                    ...
                    <div class="pt-3">
                        ...
                        <a href="{{ route('terms') }}" style="text-decoration:underline">{{ translate('terms and conditions')}}</a>,
                        <a href="{{ route('returnpolicy') }}" style="text-decoration:underline">{{ translate('return policy')}}</a> &
                        <a href="{{ route('privacypolicy') }}" style="text-decoration:underline">{{ translate('privacy policy')}}</a>
                    </div>
