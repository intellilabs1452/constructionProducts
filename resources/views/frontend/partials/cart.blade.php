...
<a href="javascript:void(0)" class="d-flex align-items-center text-reset h-100" data-toggle="dropdown" data-display="static">
    <i class="la la-shopping-cart la-2x opacity-80 " style="font-size:31px"></i>
    <span class="flex-grow-1 ml-1">
        @if(isset($cart) && count($cart) > 0)
            <span class="badge badge-color badge-inline badge-pill cart-count">
                {{ count($cart)}}
            </span>
        @else
            <span class="badge badge-color badge-inline badge-pill cart-count">0</span>
        @endif
