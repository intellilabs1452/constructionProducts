                            ...
                            <div class="col-md-6">
                                <table class="table">
                                    ...
                                    <tr>
                                      ...
                                      <tr>
                                        <td class="w-50 fw-600">{{ translate('Seller Details')}}:</td>
                                        <td>{{ ucfirst($seller->name) }}<br>{{ ucfirst($seller->address) }}<br>{{ ucfirst($seller->phone) }}</td>
                                    </tr>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            ...
                                                            @elseif ($orderDetail->shipping_type == 'pickup_point')
                                                                ...
                                                                @endif
                                                        @elseif($orderDetail->shipping_type == 'pickup_store'){{ translate('Pickup from Store')}}
                                                            @endif
                                                        </td>
