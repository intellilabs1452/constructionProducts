                        ...
                        <div class="text-left">
                            ...
                            <div class="row align-items-center">
                                ...
                                @if (get_setting('conversation_system') == 1)
                                    <div class="col-auto">
                                        <button class="btn btn-sm btn-soft-primary" onclick="show_chat_modal()">{{ translate('Technical Enquiry')}}</button>
                                    </div>
                                @endif
                            ...
                            <form id="option-choice-form">
                                ...
                                <div class="row no-gutters">
                                    <div class="col-sm-2">
                                        <div class="opacity-50 my-2">{{ translate('Inventory')}}:</div>
                                    </div>
                                    <div class="col-sm-10">
                            ...
                            <div class="mt-3">
                                ...
                                <button type="button" class="btn btn-primary buy-now fw-600" onclick="buyNow()">
                                 ...
                                 @if ($detailedProduct->linked_products != '[]')
                                <a href="{{ route('products.linked',[$detailedProduct->linked_products,$detailedProduct->name]) }}" class="btn linked fw-600" style="background-color:green;color:white">
                                   {{ translate('Linked Products')}}
                                </a>
                                @endif
                            ...
                            <div class="row no-gutters mt-4">
                                 @if ($detailedProduct->linked_products != '[]')
                                <div class="col-sm-2">
                                    <div class="opacity-50 my-2">{{ translate('Linked Products')}}:</div>
                                </div>
                                <div class="col-sm-10">
                                    @foreach ($linked_products as $key => $prod)
                                    <a href="{{ route('product', $prod->slug) }}">
                                <img src="{{ uploaded_asset($prod->thumbnail_img) }}" style="width:70px;height:70px;" title="{{ $prod->name  }}">
                                    </a>
                                   @endforeach
                                </div>
                                @endif
                        ...
                        <div class="tab-content pt-0">
                            ...
                            <div class="tab-pane fade" id="tab_default_3">
                                <div class="p-4 text-center ">
                                    <a href="{{ uploaded_asset($detailedProduct->pdf) }}" class="btn btn-primary">{{  translate('Brochure') }}</a>
                                </div>
                            </div>
        ...
        <div class="modal-dialog modal-dialog-centered modal-dialog-zoom product-modal" id="modal-size" role="document">
            <div class="modal-content position-relative">
                ...
                <form class="" action="{{ route('conversations.store') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="modal-body gry-bg px-3 pt-3">
                        <div class="form-group">
                            <input type="text" class="form-control mb-3" name="name" value="" placeholder="{{ translate('Enter Your Name') }}" required>
                        </div>
                         <div class="form-group">
                            <input type="text" class="form-control mb-3" name="phone" value="" placeholder="{{ translate('Enter Your Phone Number') }}" required>
                        </div>
                         <div class="form-group">
                            <input type="text" class="form-control mb-3" name="email" value="" placeholder="{{ translate('Enter Your Email') }}" required>
                        </div>
                        <div class="form-group">
                            <input type="text" class="form-control mb-3" name="title" value="{{ $detailedProduct->name }}" placeholder="{{ translate('Product Name') }}" required>
                        </div>
                    ...
                    <div class="modal-footer">
                        <button type="button" class="btn btn-outline-primary fw-600" data-dismiss="modal">{{ translate('Cancel')}}</button>
                        <button type="submit" class="btn btn-primary fw-600">{{ translate('Send')}}</button>
                        <button type="button" class="btn btn-primary fw-600" onclick="$('#login_modal').modal('show');">{{ translate('Login')}}</button>
                    </div>
                </form>
            </div>
        </div>
