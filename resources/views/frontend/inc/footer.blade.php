            ...
            <div class="col-lg-5 col-xl-4 text-center text-md-left">
                <div class="mt-4">
                    ...
                    <ul class="list-unstyled">
                                                                                <li class="mb-2">
                                <a href="https://constructionproducts.org/technicalquery" class="opacity-50 hov-opacity-100 text-reset">
                                    Technical Query
                                </a>
                            </li>
                                                        <li class="mb-2">
                                <a href="https://constructionproducts.org/applicators" class="opacity-50 hov-opacity-100 text-reset">
                                   Find Applicators/Skilled Traders
                                </a>
                            </li>
                                                        <li class="mb-2">
                                <a href="https://constructionproducts.org/blog" class="opacity-50 hov-opacity-100 text-reset">
                                   Blog/ Newsroom
                                </a>
                            </li>
                                                        <li class="mb-2">
                                <a href="https://constructionproducts.org/flash-deals" class="opacity-50 hov-opacity-100 text-reset">
                                    Flashed Sale/Offers
                                </a>
                            </li>
                             <li class="mb-2">
                                <a href="https://constructionproducts.org/faq" class="opacity-50 hov-opacity-100 text-reset">
                                    FAQ
                                </a>
                            </li>
                                                                        </ul>
            ...
            <div class="col-md-4 col-lg-2">
                ...
                @if (get_setting('vendor_system_activation') == 1)
                    <div class="text-center text-md-left mt-4">
                        ...
                        @else
                         <a href="{{ route('shops.create') }}" class="btn btn-primary btn-sm shadow-md" style="pointer-events: none;cursor: default;background-color:white !important;color: #c0c2cd;">
                        @endif
