								...
								<tr>
									<td>
																	...
																	<tr>
																		<td>
																			...
																			<div class="text" style="color:#949490; font-family:Arial,sans-serif, 'SSP'; font-size:14px; line-height:24px; text-align:left">
																				A request for tradesman has been shared by  {{ $details['name'] }}. The following are the details.
																			</div>
									   ...
									   <table style="width:100%; min-width:100%;color:#949490; font-family:Arial,sans-serif, 'SSP'; font-size:14px; line-height:24px; text-align:left" id="customers">
									    <tr><td style="width: 40%;">Name</td>
									    <td style="width: 60%;">{{ $details['name'] }}</td> </tr>
									    <tr><td>Mobile</td><td>{{ $details['mobile'] }}</td> </tr>
									    <tr><td>Email</td><td>{{ $details['email'] }}</td> </tr>
									    <tr><td>Address</td><td>{{ $details['address'] }}</td> </tr>
									    <tr><td>Category</td><td>{{ $details['category'] }}</td> </tr>
									    <tr><td>New/Maintenance</td><td>{{ $details['type'] }}</td> </tr>
									    <tr><td>Type of work</td><td>{{ $details['typeofwork'] }}</td> </tr>
