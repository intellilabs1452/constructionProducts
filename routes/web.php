...
Route::get('/users/registration2/{slug}', 'HomeController@registration2')->name('user.registration2');
Route::get('/users/edit_creditfacility/{slug}', 'HomeController@edit_creditfacility')->name('user.edit_creditfacility');

//Route::post('/users/login', 'HomeController@user_login')->name('user.login.submit');
Route::post('/users/login/cart', 'HomeController@cart_login')->name('cart.login.submit');
Route::post('/register2', 'Auth\RegisterController@register2')->name('user.register2');

Route::post('/updateregister2', 'Auth\RegisterController@updatecreditfacility')->name('user.updateregister2');
Route::post('/feedbacksubmit', 'HomeController@feedbacksubmit')->name('feedbacksubmit');
Route::post('/technicalquerysubmit', 'HomeController@technicalquerysubmit')->name('technicalquerysubmit');

Route::post('/applicatorsubmit', 'HomeController@applicatorsubmit')->name('applicatorsubmit');

//Home Page
Route::get('/demologin', 'HomeController@demologin')->name('demo');
Route::post('/demologinsubmit', 'HomeController@demologinsubmit')->name('demologinsubmit');
Route::get('/', 'HomeController@demologin')->name('landing');
...
Route::post('/home/section/premium_sellers', 'HomeController@load_premium_sellers_section')->name('home.section.premium_sellers');
...
Route::get('/seller-packages-list', 'HomeController@seller_package_index')->name('seller_packages_list_show');
...
Route::get('/linked/{id}/
{pid}', 'SearchController@listingByLinked')->name('products.linked');

Route::get('/brand/{brand_slug}', 'SearchController@listingByBrand')->name('products.brand');
Route::get('/bysellers/{id}/{location}', 'SearchController@listingBySeller')->name('products.bysellers');
Route::get('/sellers/{id}', 'HomeController@sellersbylocation')->name('location.sellers');
...
Route::group(['prefix' => 'checkout', 'middleware' => ['user', 'verified', 'unbanned']], function() {
   // Route::get('/', 'CheckoutController@get_shipping_info')->name('checkout.shipping_info');
    ...
    //Route::post('/payment_select', 'CheckoutController@store_delivery_info')->name('checkout.store_delivery_info');
     Route::get('/', 'CheckoutController@get_delivery_info')->name('checkout.shipping_info');
    Route::any('/payment-select', 'CheckoutController@store_shipping_info')->name('checkout.store_shipping_infostore');
    Route::any('/shipping_select', 'CheckoutController@store_delivery_info')->name('checkout.store_delivery_info');
...
Route::get('/locations', 'HomeController@all_locations')->name('locations.all');
Route::get('/feedback', 'HomeController@feedback')->name('feedback');
Route::get('/technicalquery', 'HomeController@technicalquery')->name('technicalquery');
Route::get('/applicators', 'HomeController@applicators')->name('applicators');
...
Route::group(['middleware' => ['user', 'verified', 'unbanned']], function() {
    ...
    Route::post('/seller_packages_list/purchase', 'SellerPackageController@purchase_package')->name('seller_packages_list.purchase');
    Route::post('/offline-seller-package-purchase', 'SellerPackageController@purchase_package')->name('offline_package_purchase');
...
Route::group(['middleware' => ['auth']], function() {
    ...
    Route::post('/products/sku_combination', 'ProductController@sku_combination')->name('products.sku_combination');
     Route::post('/products/update_segment', 'ProductController@update_segment')->name('products.update_segment');
...
Route::get('/createshop', 'ShopController@createform')->name('createshop');
Route::resource('conversations', 'ConversationController');
