...
Route::prefix('v2')->group(function () {
    ...
    Route::apiResource('locations', 'Api\V2\LocationController')->only('index');
    Route::get('premiumsellers', 'Api\V2\LocationController@premiumsellers');
    Route::get('location/seller/{id}', 'Api\V2\LocationController@seller');
    ...
    Route::get('products/brand/{id}', 'Api\V2\ProductController@brand')->name('api.products.brand');
     Route::get('products/seller/{id}/{lid}', 'Api\V2\ProductController@sellerproduct')->name('api.products.seller');
    ...
    Route::get('get-search-suggestions', 'Api\V2\SearchController@ajax_search')->middleware('auth:api');
