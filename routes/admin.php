...
Route::group(['prefix' => 'admin', 'middleware' => ['auth', 'admin']], function() {
    //Update Routes
    Route::resource('sellerpackages', 'SellerPackageController');
    Route::post('/update_permission/{id}', 'SellerPackageController@update_permission')->name('sellerpackages.update_permission');
    ...
    Route::get('/segments/edit/{id}', 'SegmentController@edit')->name('segments.edit');
    Route::get('/segments/destroy/{id}', 'SegmentController@destroy')->name('segments.destroy');
    ...
    Route::get('/speciality/destroy/{id}', 'SpecialityController@destroy')->name('speciality.destroy');
    
     Route::resource('skilledtrades', 'SkilledtradeController');
    Route::get('/skilledtrades/edit/{id}', 'SkilledtradeController@edit')->name('skilledtrades.edit');
    Route::get('/skilledtrades/destroy/{id}', 'SkilledtradeController@destroy')->name('skilledtrades.destroy');
    ...
    Route::get('/sellerpermission/edit/{id}', 'SellerPackageController@edit_permission')->name('sellerpermission.edit');
    ...
    Route::get('/all_orders', 'OrderController@all_orders')->name('all_orders.index');
     Route::get('/credit_report', 'OrderController@credit_report')->name('credit_report');
    ...
    Route::post('/sellers/approved', 'SellerController@updateApproved')->name('sellers.approved');
     Route::post('/sellers/paymentstatus', 'SellerController@updatePaymentstatus')->name('sellers.paymentstatus');
     Route::post('/sellers/updatepackage', 'SellerController@updatePackage')->name('sellers.updatepackage');
